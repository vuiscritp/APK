...
android {
    namespace = "com.aidev.assistant"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.aidev.assistant"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    implementation("androidx.fragment:fragment-ktx:1.8.4") // fixes InvalidFragmentVersionForActivityResult lint error
